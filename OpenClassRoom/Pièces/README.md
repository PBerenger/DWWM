...
Pour le bon fonctionnement du projet, il faut lancer le serveur http avec `npm run dev` sur la racine et lancer le serveur json avec `npm start` dans le dossier api-http.