...
if (isset($_SESSION['id_user'])) {
    ...
    try {
        ...
        $reponses = [
            ...
            'écologique' => getPostValue('question01') + getPostValue('question13') + getPostValue('question21') + getPostValue('question26') + getPostValue('question37') + getPostValue('question47') + getPostValue('question54') + getPostValue('question61') + getPostValue('question67') + getPostValue('question75'),
            'kinesthésique' => getPostValue('question03') + getPostValue('question16') + getPostValue('question22') + getPostValue('question32') + getPostValue('question43') + getPostValue('question46') + getPostValue('question52') + getPostValue('question64') + getPostValue('question69') + getPostValue('question77'),
