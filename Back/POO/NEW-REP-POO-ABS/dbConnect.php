...
abstract class DbConnect {
    ...
    public static function getInstance() {
        // "self::" fait référence à une instance statique (ne peux pas s'en servir ailleurs)
        if (!self::$instance) {
            // "new statice()" créé une nouvelle instance (fait référence au construct plus haut)
