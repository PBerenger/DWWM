...
<form id="questions" action="./Controllers/traitementQuestions.php" method="POST">
    <p>J'aime les livres parlant d'animaux.</p>
    <input type="radio" name="question01" id="oui01" value="5" required>
    ...
    <input type="radio" name="question02" id="oui02" value="7" required>
    ...
    <input type="radio" name="question03" id="oui03" value="6" required>
    ...
    <input type="radio" name="question04" id="oui04" value="2" required>
    ...
    <input type="radio" name="question06" id="oui06" value="3" required>
    ...
    <input type="radio" name="question07" id="oui07" value="8" required>
    ...
    <input type="radio" name="question08" id="oui08" value="4" required>
    ...
    <input type="radio" name="question09" id="oui09" value="7" required>
    ...
    <input type="radio" name="question10" id="oui10" value="4" required>
    ...
    <input type="radio" name="question11" id="oui11" value="3" required>
    ...
    <input type="radio" name="question12" id="oui12" value="8" required>
    ...
    <input type="radio" name="question13" id="oui13" value="5" required>
    ...
    <input type="radio" name="question15" id="oui15" value="2" required>
    <label for="oui15">Oui</label>
    <input type="radio" name="question15" id="non15" value="0" required>
    <label for="non15">Non</label>

    <p>J'aime la danse.</p>
    <input type="radio" name="question16" id="oui16" value="6" required>
    ...
    <input type="radio" name="question18" id="oui18" value="3" required>
    ...
    <input type="radio" name="question19" id="oui19" value="7" required>
    ...
    <input type="radio" name="question20" id="oui20" value="4" required>
    ...
    <input type="radio" name="question21" id="oui21" value="5" required>
    ...
    <input type="radio" name="question22" id="oui22" value="6" required>
    ...
    <input type="radio" name="question23" id="oui23" value="8" required>
    ...
    <input type="radio" name="question24" id="oui24" value="2" required>
    ...
    <input type="radio" name="question26" id="oui26" value="5" required>
    ...
    <input type="radio" name="question27" id="oui27" value="2" required>
    ...
    <input type="radio" name="question28" id="oui28" value="8" required>
    ...
    <input type="radio" name="question29" id="oui29" value="7" required>
    ...
    <input type="radio" name="question30" id="oui30" value="4" required>
    ...
    <input type="radio" name="question31" id="oui31" value="3" required>
    ...
    <input type="radio" name="question32" id="oui32" value="6" required>
    ...
    <input type="radio" name="question33" id="oui33" value="8" required>
    ...
    <input type="radio" name="question34" id="oui34" value="2" required>
    ...
    <input type="radio" name="question35" id="oui35" value="3" required>
    ...
    <input type="radio" name="question36" id="oui36" value="4" required>
    ...
    <input type="radio" name="question37" id="oui37" value="5" required>
    ...
    <input type="radio" name="question38" id="oui38" value="3" required>
    ...
    <input type="radio" name="question39" id="oui39" value="7" required>
    ...
    <input type="radio" name="question41" id="oui41" value="8" required>
    ...
    <input type="radio" name="question43" id="oui43" value="6" required>
    ...
    <input type="radio" name="question44" id="oui44" value="4" required>
    ...
    <input type="radio" name="question45" id="oui45" value="2" required>
    ...
    <input type="radio" name="question46" id="oui46" value="6" required>
    ...
    <input type="radio" name="question47" id="oui47" value="5" required>
    ...
    <input type="radio" name="question48" id="oui48" value="7" required>
    ...
    <input type="radio" name="question49" id="oui49" value="7" required>
    ...
    <input type="radio" name="question50" id="oui50" value="2" required>
    ...
    <input type="radio" name="question51" id="oui51" value="4" required>
    ...
    <input type="radio" name="question52" id="oui52" value="6" required>
    ...
    <input type="radio" name="question53" id="oui53" value="8" required>
    ...
    <input type="radio" name="question54" id="oui54" value="5" required>
    ...
    <input type="radio" name="question56" id="oui56" value="3" required>
    ...
    <input type="radio" name="question57" id="oui57" value="3" required>
    ...
    <input type="radio" name="question58" id="oui58" value="4" required>
    ...
    <input type="radio" name="question59" id="oui59" value="2" required>
    ...
    <input type="radio" name="question61" id="oui61" value="5" required>
    ...
    <input type="radio" name="question62" id="oui62" value="7" required>
    ...
    <input type="radio" name="question63" id="oui63" value="8" required>
    ...
    <input type="radio" name="question64" id="oui64" value="6" required>
    ...
    <input type="radio" name="question65" id="oui65" value="7" required>
    ...
    <input type="radio" name="question66" id="oui66" value="4" required>
    ...
    <input type="radio" name="question67" id="oui67" value="5" required>
    ...
    <input type="radio" name="question68" id="oui68" value="8" required>
    ...
    <input type="radio" name="question69" id="oui69" value="6" required>
    ...
    <input type="radio" name="question70" id="oui70" value="2" required>
    ...
    <input type="radio" name="question72" id="oui72" value="3" required>
    ...
    <input type="radio" name="question73" id="oui73" value="2" required>
    ...
    <input type="radio" name="question74" id="oui74" value="8" required>
    ...
    <input type="radio" name="question75" id="oui75" value="5" required>
    ...
    <input type="radio" name="question76" id="oui76" value="4" required>
    ...
    <input type="radio" name="question77" id="oui77" value="6" required>
    ...
    <input type="radio" name="question79" id="oui79" value="3" required>
    ...
    <input type="radio" name="question80" id="oui80" value="7" required>
